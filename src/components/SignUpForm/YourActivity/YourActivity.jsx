                ...
                <YourActivityList>
                  <RadioButtonContainerStyled>
                    ...
                    <RadioLabelStyle htmlFor="low 1.2-1.3">
                      1.2-1.3 - if you do not have physical activity and sedentary
                      work
                    </RadioLabelStyle>
                  </RadioButtonContainerStyled>
                  ...
                  <RadioButtonContainerStyled>
                    ...
                    <RadioLabelStyle htmlFor="light 1.4-1.5">
                      1.4-1.5 - if you do short runs or light gymnastics 1-3 times
                      a week
                    </RadioLabelStyle>
                  </RadioButtonContainerStyled>
                  ...
                  <RadioButtonContainerStyled>
                    ...
                    <RadioLabelStyle htmlFor="average 1.6-1.7">
                      1.6-1.7 - if you play sports with average loads 3-5 times a
                      week
                    </RadioLabelStyle>
                  </RadioButtonContainerStyled>
