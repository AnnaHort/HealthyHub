import{s as e,N as L,j as t,r as i,a as g,u as f,b as y,c as u,d as S,e as B,Q as w,f as P,g as M,L as U,h as W,l as F,U as H,k as G,i as T,O as A}from"./index-b5584dc0.js";const O=e(L)`
  font-family: Poppins;
...
`,Nt=e.svg`
  ...
  stroke: var(--color-primary-grey);
  margin-right: 8px;
`,Vt=({onCloseButtonClick:n})=>{const[o,r]=i.useState(""),[l,d]=i.useState(),c=f(y),h=u(),m=async a=>{a.preventDefault();const s={weight:o};try{const v=await g.put("/api/user/update",s);w.success(v.data.message,{autoClose:2e3}),h(S(s)),h(B()),n()}catch(v){console.error("Data error",v.message),w.error("Error updating user information")}},x=a=>{(a.code==="Escape"||a.currentTarget===a.target)&&n()};i.useEffect(()=>(window.addEventListener("keydown",x),()=>{window.removeEventListener("keydown",x)})),i.useEffect(()=>{(async()=>{try{const s=await g.get("api/user/current");d(s.data)}catch(s){console.error("Data error",s.message)}})()},[c]);const p=new Date().toLocaleDateString();return l?t.jsx(zt,{onClick:x,children:t.jsx(Dt,{children:t.jsx(Pt,{children:t.jsxs(It,{children:[t.jsxs(Rt,{children:[t.jsx(Ut,{children:"Enter your current weight"}),t.jsx(Zt,{onClick:n,children:t.jsx(Nt,{children:t.jsx(k,{})})})]}),t.jsx(Wt,{children:"You can record your weight once a day"}),t.jsxs(Ft,{children:["Today: ",t.jsx(Ht,{children:p})]}),t.jsxs(Gt,{onSubmit:m,children:[t.jsx(Tt,{type:"number",placeholder:"Enter your weight",min:"1",max:"300",value:o,onChange:a=>r(a.target.value)}),t.jsx(At,{type:"submit",children:"Confirm"}),t.jsx(Ot,{onClick:n,children:"Cancel"})]})]})})})}):t.jsx("div",{children:"Loading..."})},Qt="/HealthyHub/assets/WaightImage-833d9f56.svg",Yt=()=>t.jsxs("svg",{xmlns:"http://www.w3.org/2000/svg",width:"24",height:"24",viewBox:"0 0 32 32",fill:"none",children:[t.jsx("path",{d:"M13.2599 3.59997L5.04985 12.29C4.73985 12.62 4.43985 13.27 4.37985 13.72L4.00985 16.96C3.87985 18.13 4.71985 18.93 5.87985 18.73L9.09985 18.18C9.54985 18.1 10.1799 17.77 10.4899 17.43L18.6999 8.73997C20.1199 7.23997 20.7599 5.52997 18.5499 3.43997C16.3499 1.36997 14.6799 2.09997 13.2599 3.59997Z",stroke:"",strokeWidth:"1.5",strokeMiterlimit:"10",strokeLinecap:"round",strokeLinejoin:"round"}),t.jsx("path",{d:"M11.8901 5.05005C12.3201 7.81005 14.5601 9.92005 17.3401 10.2",stroke:"",strokeWidth:"1.5",strokeMiterlimit:"10",strokeLinecap:"round",strokeLinejoin:"round"}),t.jsx("path",{d:"M3 22H21",stroke:"",strokeWidth:"1.5",strokeMiterlimit:"10",strokeLinecap:"round",strokeLinejoin:"round"})]});g.defaults.baseURL="https://healthhub-backend.onrender.com";const I=()=>{const[n,o]=i.useState(!1),[r,l]=i.useState(null),d=f(y),c=u();i.useEffect(()=>{d&&c(M())},[d,c]),i.useEffect(()=>{(async()=>{try{const p=await g.get("api/user/current");l(p.data)}catch(p){console.error("Data error",p.message)}})()},[d]);const h=()=>{o(!0)},m=()=>{o(!1)};return r?t.jsxs(bt,{children:[t.jsx(Ct,{children:t.jsx("img",{src:Qt,alt:"MaintakeMen"})}),t.jsxs(Mt,{children:[t.jsx(Lt,{children:"Weight"}),t.jsxs(Et,{children:[r.weight," ",t.jsx("span",{children:"kg"}),t.jsx(St,{onClick:h,children:t.jsx(Bt,{children:t.jsx(Yt,{})})})]})]}),n&&t.jsx($t,{children:t.jsx(Vt,{onCloseButtonClick:m})})]}):t.jsx("div",{children:"Loading..."})},qt=e.div`
  width: 130px;
  height: 28px;
  display: flex;
  align-items: center;
