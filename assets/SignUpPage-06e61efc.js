...
`,Ni=e.div`
  color: #e74a3b;
  margin-bottom: 20px;
`,Ti={gender:"",age:""},Di=g().shape({gender:h().required("Select gender").oneOf(["male","female"]),age:G().required("Specify age").integer("Age must be an integer").min(1,"Minimum age is 1 year").max(100,"Maximum age is 100 years")}),Li=({onNext:o,onBack:a,onSubmit:t})=>i.jsxs(ui,{children:[i.jsx(fi,{src:Pi,srcSet:`${zi} 834w, ${Ai} 1440w`,sizes:"(max-width: 833px) 100vw, (min-width: 834px) 50vw",alt:"Responsive Image"}),i.jsxs("div",{children:[i.jsx(yi,{children:"Select gender, Age"}),i.jsx(wi,{children:"Choose a goal so that we can help you effectively"}),i.jsx(u,{initialValues:Ti,validationSchema:Di,onSubmit:(n,{setSubmitting:l})=>{t(n),o(),l(!1)},children:({errors:n})=>i.jsxs(bi,{children:[i.jsx(z,{children:"Gender"}),i.jsxs(vi,{children:[i.jsxs(p,{children:[i.jsx(m,{type:"radio",id:"male",name:"gender",value:"male"}),i.jsx(x,{style:{width:"120px",textAlign:"start"},htmlFor:"male",children:"Male"})]}),i.jsxs(p,{children:[i.jsx(m,{type:"radio",id:"female",name:"gender",value:"female"}),i.jsx(x,{htmlFor:"female",children:"Female"})]})]}),i.jsx(Fi,{children:n.gender}),i.jsxs("label",{htmlFor:"age",children:[i.jsx(z,{children:"Your age"}),i.jsx(ji,{children:i.jsx(Si,{type:"number",id:"age",name:"age",placeholder:"Enter your age"})})]}),i.jsx(Gi,{children:n.age}),i.jsx(ki,{type:"submit",children:"Next"}),i.jsx(Bi,{onClick:a,children:"Back"})]})})]})]}),Vi=({onNext:o,onBack:a,onSubmit:t})=>i.jsx("div",{children:i.jsx(Li,{onBack:a,onNext:o,onSubmit:t})}),Ui=e.div`
display: flex;
flex-direction: column;
`,A=e.label`
  font-family: Poppins;
