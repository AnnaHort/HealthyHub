import{c as g,b as h,j as i,S as T,I as D,R as L,d as V,e as U,F as u,f as W,g as j,E as v,B as Q,Q as O,h as J,i as K,s as e,k as w,l as b,m as G,n as X,r as d,o as Z,p as _,q as S}from"./index-8ed0db88.js";const ii={name:"",email:"",password:""},ei=/^\w+([.-]?\w+)*@\w+([.-]?\w+)*(\.\w{2,3})+$/,ti=g().shape({name:h().required("Name is required"),email:h().matches(ei,"Invalid email").required("Email is required"),password:h().min(6,"Password must be at least 6 characters").required("Password is required")}),ni=({onSubmit:o,onNext:a})=>i.jsxs(T,{children:[i.jsx(D,{src:L,alt:"Responsive Image"}),i.jsxs("div",{children:[i.jsx(V,{children:"Sign up"}),i.jsx(U,{children:"You need to register to use the service"}),i.jsx(u,{initialValues:ii,validationSchema:ti,onSubmit:(t,{setSubmitting:n})=>{o(t),a(),n(!1)},children:({errors:t,touched:n})=>i.jsxs(W,{autoComplete:"off",children:[i.jsxs("label",{htmlFor:"name",children:[i.jsx(j,{name:"name",placeholder:"Name"}),t.name&&n.name?i.jsx(v,{children:t.name}):null]}),i.jsxs("label",{htmlFor:"email",children:[i.jsx(j,{name:"email",type:"email",placeholder:"E-mail"}),t.email&&n.email?i.jsx(v,{children:t.email}):null]}),i.jsxs("label",{htmlFor:"password",children:[i.jsx(j,{name:"password",type:"password",placeholder:"Password"}),t.password&&n.password?i.jsx(v,{children:t.password}):null]}),i.jsx(Q,{type:"submit",children:"Next"}),i.jsxs(O,{children:[i.jsx(J,{children:"Do you already have an account?"}),i.jsx(K,{to:"/signin",children:"Sign in"})]})]})})]})]}),ai=e.div`
...
`,Gi=e.div`
  color: #e74a3b;
  margin-bottom: 20px;
`,Pi="/HealthyHub/assets/gender-and-age-mobile-541c31ba.png",zi="/HealthyHub/assets/gender-and-age-tablet-99eb88e0.png",Ai="/HealthyHub/assets/gender-and-age-desktop-cc0787a2.png",Ci=e.div`
  background-color: var(--color-primary-black);
  padding: 24px 10px;
  @media (min-width: 834px) {
    padding-top: 40px;
...
`,Ni=e.div`
  color: #e74a3b;
  margin-bottom: 20px;
`,Ti={gender:"",age:""},Di=g().shape({gender:h().required("Select gender").oneOf(["male","female"]),age:G().required("Specify age").integer("Age must be an integer").min(1,"Minimum age is 1 year").max(100,"Maximum age is 100 years")}),Li=({onNext:o,onBack:a,onSubmit:t})=>i.jsxs(ui,{children:[i.jsx(fi,{src:Pi,srcSet:`${zi} 834w, ${Ai} 1440w`,sizes:"(max-width: 833px) 100vw, (min-width: 834px) 50vw",alt:"Responsive Image"}),i.jsxs("div",{children:[i.jsx(yi,{children:"Select gender, Age"}),i.jsx(wi,{children:"Choose a goal so that we can help you effectively"}),i.jsx(u,{initialValues:Ti,validationSchema:Di,onSubmit:(n,{setSubmitting:l})=>{t(n),o(),l(!1)},children:({errors:n})=>i.jsxs(bi,{children:[i.jsx(z,{children:"Gender"}),i.jsxs(ji,{children:[i.jsxs(p,{children:[i.jsx(m,{type:"radio",id:"male",name:"gender",value:"male"}),i.jsx(x,{style:{width:"120px",textAlign:"start"},htmlFor:"male",children:"Male"})]}),i.jsxs(p,{children:[i.jsx(m,{type:"radio",id:"female",name:"gender",value:"female"}),i.jsx(x,{htmlFor:"female",children:"Female"})]})]}),i.jsx(Fi,{children:n.gender}),i.jsxs("label",{htmlFor:"age",children:[i.jsx(z,{children:"Your age"}),i.jsx(vi,{children:i.jsx(Si,{type:"number",id:"age",name:"age",placeholder:"Enter your age"})})]}),i.jsx(Gi,{children:n.age}),i.jsx(ki,{type:"submit",children:"Next"}),i.jsx(Bi,{onClick:a,children:"Back"})]})})]})]}),Vi=({onNext:o,onBack:a,onSubmit:t})=>i.jsx("div",{children:i.jsx(Li,{onBack:a,onNext:o,onSubmit:t})}),Ui=e.div`
display: flex;
flex-direction: column;
`,A=e.label`
  font-family: Poppins;
