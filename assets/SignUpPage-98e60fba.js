...
`,_t=r.div`
  color: #e74a3b;
  margin-bottom: 20px;
`,Ft={gender:"",age:""},zt=J().shape({gender:U().required("Select gender").oneOf(["male","female"]),age:fe().required("Specify age").integer("Age must be an integer").min(1,"Minimum age is 1 year").max(100,"Maximum age is 100 years")}),Mt=({onNext:e,onBack:i,onSubmit:n})=>t.jsxs(ct,{children:[t.jsx(pt,{src:jt,srcSet:`${Tt} 834w, ${Et} 1440w`,sizes:"(max-width: 833px) 100vw, (min-width: 834px) 50vw",alt:"Responsive Image"}),t.jsxs("div",{children:[t.jsx(mt,{children:"Select gender, Age"}),t.jsx(ht,{children:"Choose a goal so that we can help you effectively"}),t.jsx(Z,{initialValues:Ft,validationSchema:zt,onSubmit:(o,{setSubmitting:p})=>{n(o),e(),p(!1)},children:({errors:o})=>t.jsxs(ut,{children:[t.jsx(je,{children:"Gender"}),t.jsxs(gt,{children:[t.jsxs(H,{children:[t.jsx(q,{type:"radio",id:"male",name:"gender",value:"male"}),t.jsx(Y,{style:{width:"120px",textAlign:"start"},htmlFor:"male",children:"Male"})]}),t.jsxs(H,{children:[t.jsx(q,{type:"radio",id:"female",name:"gender",value:"female"}),t.jsx(Y,{htmlFor:"female",children:"Female"})]})]}),t.jsx(vt,{children:o.gender}),t.jsxs("label",{htmlFor:"age",children:[t.jsx(je,{children:"Your age"}),t.jsx(xt,{children:t.jsx(ft,{type:"number",id:"age",name:"age",placeholder:"Enter your age"})})]}),t.jsx(bt,{children:o.age}),t.jsx(yt,{type:"submit",children:"Next"}),t.jsx(wt,{onClick:i,children:"Back"})]})})]})]}),At=({onNext:e,onBack:i,onSubmit:n})=>t.jsx("div",{children:t.jsx(Mt,{onBack:i,onNext:e,onSubmit:n})}),Ot={activity:""},Gt=J({activity:U().required("Сhoose your activity level").oneOf(["low 1.2","light 1.375","average 1.55","high 1.725","hard 1.9"])}),$t=({onBack:e,onSubmit:i})=>t.jsxs(kt,{children:[t.jsx(Ct,{src:"/src/img/YourActivityImg/illustrationActivity-min.svg"}),t.jsxs(St,{children:[t.jsx(It,{children:"Your Activity"}),t.jsx(Bt,{children:"To correctly calculate calorie and water intake"}),t.jsx(Z,{initialValues:Ot,validationSchema:Gt,onSubmit:(n,{setSubmitting:o})=>{i(n),o(!1)},children:({errors:n})=>t.jsxs(Rt,{action:"#",children:[t.jsxs(Lt,{children:[t.jsxs(H,{children:[t.jsx(q,{type:"radio",id:"low 1.2",value:"low 1.2",name:"activity"}),t.jsx(Y,{htmlFor:"low 1.2",children:"1.2 - if you do not have physical activity and sedentary work"})]}),t.jsxs(H,{children:[t.jsx(q,{type:"radio",id:"light 1.375",value:"light 1.375",name:"activity"}),t.jsx(Y,{htmlFor:"light 1.375",children:"1.375 - if you do short runs or light gymnastics 1-3 times a week"})]}),t.jsxs(H,{children:[t.jsx(q,{type:"radio",id:"average 1.55",value:"average 1.55",name:"activity"}),t.jsx(Y,{htmlFor:"average 1.55",children:"1.55 - if you play sports with average loads 3-5 times a week"})]}),t.jsxs(H,{children:[t.jsx(q,{type:"radio",id:"high 1.725",value:"high 1.725",name:"activity"}),t.jsx(Y,{htmlFor:"high 1.725",children:"1.725 - if you train fully 6-7 times a week"})]}),t.jsxs(H,{children:[t.jsx(q,{type:"radio",id:"hard 1.9",value:"hard 1.9",name:"activity"}),t.jsx(Y,{htmlFor:"hard 1.9",children:"1.9 - if your work is related to physical labor, you train 2 times a day and include strength exercises in your training program"})]})]}),t.jsx(_t,{children:n.activity}),t.jsx(Pt,{type:"submit",children:"Sign Up"}),t.jsx(Nt,{type:"button",onClick:e,children:"Back"})]})})]})]}),Dt=r.div`
display: flex;
flex-direction: column;
`,Te=r.label`
  font-family: Poppins;
...
`,Qt=r.div`
  ...
  margin-bottom: 20px;
  margin-top: 20px;
`,Ut={height:"",weight:""},Wt=J().shape({weight:fe().required("Weight is required").min(1,"Weight should be greater than 0").positive("Weight should be a positive number"),height:fe().required("Height is required").min(1,"Height should be greater than 0").positive("Height should be a positive number")}),Xt=({onBack:e,onNext:i,onSubmit:n})=>t.jsx(Dt,{children:t.jsx(Z,{initialValues:Ut,validationSchema:Wt,onSubmit:(o,{setSubmitting:p})=>{n(o),i(),p(!1)},children:({errors:o})=>t.jsxs(Ht,{children:[t.jsx(Te,{htmlFor:"height",children:"Height"}),t.jsx(Ee,{name:"height",type:"number",id:"height",placeholder:"Enter your height"}),t.jsx(Qt,{children:o.height}),t.jsx(Te,{htmlFor:"weight",children:"Weight"}),t.jsx(Ee,{name:"weight",type:"number",id:"weight",placeholder:"Enter your weight"}),t.jsx(Vt,{children:o.weight}),t.jsxs("div",{children:[t.jsx(qt,{type:"submit",children:"Next"}),t.jsx(Yt,{type:"button",onClick:e,children:"Back"})]})]})})}),Kt="/HealthyHub/assets/symbol-defs-2eb7c4d7.svg#icon-body-parameters",Jt=r.svg`
  @media (min-width: 834px) {
    width: 380px;
    height: 376px;
    display: flex;
...
`,Zt=()=>t.jsx("div",{children:t.jsx(Jt,{width:"300",height:"300",children:t.jsx("use",{xlinkHref:`${Kt}#icon-body-parameters`,width:"100%",height:"100%"})})}),ei=r.div`
  display: flex;
  flex-direction: column;
  @media (min-width: 834px) {
    max-width: 444px;
...
`,ni=()=>t.jsxs(ei,{children:[t.jsx(ti,{children:"Body parameters"}),t.jsx(ii,{children:"Enter your parameters for correct performance tracking"})]}),oi=r.div`
  display: flex;
  flex-direction: column;
  justify-content: center;
