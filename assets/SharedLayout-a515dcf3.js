import{s as e,N as g,j as i,r as t,u as A,a as h,O as m}from"./index-540f7d71.js";const w=e(g)`
...
`,C=()=>i.jsxs(y,{id:"icon-profile-circle",viewBox:"0 0 32 32",children:[i.jsx("path",{fill:"none",stroke:"#fff",style:{stroke:"var(--color1, #fff)"},strokeLinejoin:"round",strokeLinecap:"round",strokeMiterlimit:"4",strokeWidth:"1.8462",d:"M16.16 17.040c-0.093-0.013-0.213-0.013-0.32 0-2.347-0.080-4.213-2-4.213-4.36 0-2.413 1.947-4.373 4.373-4.373 2.413 0 4.373 1.96 4.373 4.373-0.013 2.36-1.867 4.28-4.213 4.36z"}),i.jsx("path",{fill:"none",stroke:"#fff",style:{stroke:"var(--color1, #fff)"},strokeLinejoin:"round",strokeLinecap:"round",strokeMiterlimit:"4",strokeWidth:"1.8462",d:"M24.987 25.84c-2.373 2.173-5.52 3.493-8.987 3.493s-6.613-1.32-8.987-3.493c0.133-1.253 0.933-2.48 2.36-3.44 3.653-2.427 9.627-2.427 13.253 0 1.427 0.96 2.227 2.187 2.36 3.44z"}),i.jsx("path",{fill:"none",stroke:"#fff",style:{stroke:"var(--color1, #fff)"},strokeLinejoin:"round",strokeLinecap:"round",strokeMiterlimit:"4",strokeWidth:"1.8462",d:"M16 29.333c7.364 0 13.333-5.969 13.333-13.333s-5.97-13.333-13.333-13.333c-7.364 0-13.333 5.97-13.333 13.333s5.97 13.333 13.333 13.333z"})]}),B=e.nav`
  display: flex;
...
`,Q=()=>i.jsxs(B,{children:[i.jsx(x,{to:"/signin",children:"Sign in"}),i.jsx(u,{children:" / "}),i.jsx(x,{to:"/signup",children:"Sign up"}),i.jsx(C,{})]}),D=e.div`
  height: 60px;
  display: flex;
...
`;const j=()=>i.jsxs(D,{children:[i.jsx(f,{}),i.jsx(Q,{})]}),M=e.div`
  display: flex;
  gap: 12px;
`,k=e.div`
  width: 48px;
...
`,ui=e.div``,Qi=e.svg`
  ...
  margin-right: 8px;
`,Di=()=>i.jsx(ui,{children:i.jsxs(Bi,{children:[i.jsx(Qi,{children:i.jsx("use",{href:"/src/Sprites/icons/symbol-defs.svg#icon-setting-2"})}),"Setting"]})}),ji=e.button`
  border: none;
  background: none;
  color: var(--color-primary-white);
  font-family: Poppins;
...
`,Mi=e.div``,ki=e.svg`
  ...
  stroke: var(--color-primary-white);
  margin-right: 8px;
`,Ei=()=>i.jsx(Mi,{children:i.jsxs(ji,{children:[i.jsx(ki,{children:i.jsx("use",{href:"/src/Sprites/icons/symbol-defs.svg#icon-logout"})}),"Log out"]})}),Ii=e.div`
  width: 158px;
  height: 112px;
  padding: 24px;
  border-radius: 12px;
...
`,vi=e.div`
  ...
  flex-wrap: wrap;
  gap: 24px;
`,Yi=()=>i.jsx(Ii,{children:i.jsxs(vi,{children:[i.jsx(Di,{}),i.jsx(Ei,{})]})}),zi=()=>{const[n,o]=t.useState(!1),r=()=>{o(!0)},s=()=>{o(!1)};return i.jsxs(hi,{children:[i.jsx(mi,{children:"Konstantin"}),i.jsx(wi,{children:i.jsx("img",{src:"../../components/UserInfoNav/Avatar.svg",alt:"Avatar"})}),i.jsx(fi,{onClick:r,children:i.jsx(yi,{onClick:s,children:i.jsx("use",{href:"/src/Sprites/icons/symbol-defs.svg#icon-arrow-down"})})}),n&&i.jsx(Ci,{onClick:s,children:i.jsx(Yi,{})})]})},Gi=e.div`
  position: relative;
  height: 60px;
  margin: 0 auto;
  display: flex;
...
`,Xi=({onCloseButtonClick:n})=>i.jsxs(Li,{children:[i.jsxs(Ui,{children:[i.jsx(d,{}),i.jsx(c,{})]}),i.jsx(Ri,{children:i.jsx(Oi,{onClick:n,children:i.jsx(Si,{src:"/src/components/TargetSelectionModal/img/close-circle-min.svg",alt:"CloseButton"})})})]}),Ji=e(g)`
  color: var(--color-primary-grey);
  font-size: 16px;
  font-weight: 700;
  line-height: 1.38;
...
`,Zi=()=>i.jsx(Ji,{to:"/",children:"HealthyHub"}),Ki=()=>{const[n,o]=t.useState(!1),r=()=>{o(!0)},s=()=>{o(!1)};return i.jsxs(Gi,{children:[i.jsx(Ni,{children:i.jsx(Zi,{})}),i.jsx(Hi,{onClick:r,children:i.jsx(Fi,{isModalOpen:n,children:i.jsx("use",{href:"/src/Sprites/icons/symbol-defs.svg#icon-menu"})})}),i.jsxs(Ti,{children:[i.jsx(d,{}),i.jsx(c,{})]}),i.jsx(bi,{children:i.jsx(zi,{})}),n&&i.jsx(Pi,{isModalOpen:n,children:i.jsx(Xi,{onCloseButtonClick:s})})]})},Wi=e.div`
  background: var(--color-primary-black-2);
`,qi=e.div`
  width: 320px;
  padding-left: 10px;
...
`,$i=()=>{const n=A(h);return i.jsxs(i.Fragment,{children:[i.jsx(Wi,{children:n?i.jsx(Ki,{}):i.jsx(j,{})}),i.jsx(qi,{children:i.jsx(t.Suspense,{fallback:i.jsx("div",{children:"Loading..."}),children:i.jsx(m,{})})})]})};export{$i as default};
