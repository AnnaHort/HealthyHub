import{s as e,N as L,j as t,r as i,a as g,u as f,b as y,c as u,k as M,d as B,e as $,Q as w,f as U,g as E,L as W,h as F,l as H,U as G,i as T,O as A}from"./index-0463efb5.js";const O=e(L)`
  font-family: Poppins;
...
`,Y=()=>t.jsxs(V,{children:[t.jsx(S,{to:"/signin",children:"Sign in"}),t.jsx(Q,{children:" / "}),t.jsx(S,{to:"/signup",children:"Sign up"}),t.jsx(N,{})]}),q=e.div`
  height: 60px;
  display: flex;
...
`,ze=e.svg`
  ...
  height: 16px;
  stroke: var(--color-primary-grey);
`,De=({onCloseButtonClick:n})=>{const o=r=>{(r.code==="Escape"||r.currentTarget===r.target)&&n()};return i.useEffect(()=>(window.addEventListener("keydown",o),()=>{window.removeEventListener("keydown",o)})),t.jsx(Le,{onClick:o,children:t.jsx(Me,{children:t.jsxs(Ee,{children:[t.jsxs(Be,{children:[t.jsx(I,{}),t.jsx(P,{})]}),t.jsx(Se,{children:t.jsx($e,{onClick:n,children:t.jsx(ze,{children:t.jsx(k,{})})})})]})})})},Ie=e(L)`
  color: var(--color-primary-grey);
  font-size: 16px;
  font-weight: 700;
  line-height: 1.38;
