...
`,Ot=E.label`
  ...
  font-weight: 400;
  line-height: 20px;
`,sn=()=>f.jsxs(Qr,{children:[f.jsx(Jr,{alt:"Goal Image",src:"/src/components/YourGoal/img/Illustration Goals-min.svg"}),f.jsxs(Xr,{children:[f.jsx(tn,{children:"Your goal"}),f.jsx(en,{children:"Choose a goal so that we can help you effectively"}),f.jsxs(rn,{children:[f.jsxs(Rt,{children:[f.jsx(Nt,{type:"radio",id:"loseFat",name:"goal",value:"Lose Fat",tabIndex:0}),f.jsx(Ot,{for:"loseFat",children:"Lose Fat"})]}),f.jsxs(Rt,{children:[f.jsx(Nt,{type:"radio",id:"maintain",name:"goal",value:"Maintain",tabIndex:0}),f.jsx(Ot,{for:"maintain",children:"Maintain"})]}),f.jsxs(Rt,{children:[f.jsx(Nt,{type:"radio",id:"gainMuscle",name:"goal",value:"Gain Muscle",tabIndex:0}),f.jsx(Ot,{for:"gainMuscle",children:"Gain Muscle"})]})]}),f.jsx(nn,{children:"Next"}),f.jsx(on,{type:"button",children:"Back"})]})]}),pn=()=>f.jsxs(f.Fragment,{children:[f.jsx("header",{children:f.jsx(Zr,{children:f.jsx(Vr,{})})}),f.jsx(sn,{}),f.jsx(Gt.Suspense,{children:f.jsx(Me,{})})]});export{pn as default};
